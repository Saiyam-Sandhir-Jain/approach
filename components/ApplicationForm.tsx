        ...
        {app && (
          <div className="bento-card p-5 space-y-3">
            ...
            <button
              ...
              className={cn('text-xs font-heading font-semibold px-3 py-1.5 rounded-lg transition-all', 'disabled:opacity-40 disabled:cursor-not-allowed')}
        ...
        >
          ...
          >
            <div
              ...
              style={{ background: 'radial-gradient(ellipse 70% 50% at 50% 0%, rgba(239,68,68,0.06), transparent)' }}
            />
            ...
            <div className="text-center space-y-1.5">
              ...
              <p className="text-xs leading-relaxed" style={{ color: 'var(--text-muted)' }}>
                ...
                {' '}and all its contacts will be permanently removed.
              </p>
            </div>
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 py-2 rounded-lg font-heading font-bold text-xs text-white transition-all hover:brightness-110 active:scale-95 disabled:opacity-50"
                style={{ backgroundColor: '#ef4444', boxShadow: '0 4px 14px rgba(239,68,68,0.3)' }}
              >
                {deleting ? 'Deleting…' : 'Delete'}
              </button>
            </div>
...
function TrashIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="#f87171" strokeWidth="2" strokeLinecap="round">
